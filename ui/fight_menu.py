...
class FightMenu:
    ...
    def get_type_index(self, type_name):
        try:
            return self.type_order.index(type_name)
        except ValueError:
            return 0
    ...
    def draw(self):
        ...
        for i, (x, y) in enumerate(self.button_positions):
            ...
            type_index = self.get_type_index(move_type)
        ...
        for i, move in enumerate(self.moves):
            ...
            name_surf = self.font.render(move["name"], True, (32, 32, 32))
        ...
        if self.moves:
            ...
            type_idx = self.get_type_index(move_type)
            type_icon_x = 416
            ...
            pp_surf = self.pp_font.render(pp_text, True, (32, 32, 32))
